  ...
  <body class="sty">
    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="col-lg-3" id="side_bar">
                ...
                <p class="p-2">
                    <b><h7> Welcome to Issue Napkins : </h7></b>
            ...
            <div class="col-lg-9">
                ...
                <br>
                <div class="col-lg-10">
                    <form action="" method="post" class="p-3" onsubmit="return validate()">
                                    ...
                                    <div class="form-row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="text" name="gender" class="form-control" required value="<?php echo $gender;?>" id="gender" disabled>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="s_id" name="s_id" placeholder="Student ID" required value="<?php echo $s_id ?>"> <br>
                        ...
                        <div class="col-lg-6">
                            <button type="submit" class="btn btn-success btn-block" name="issue_nap">Issue </button>
                        </div>
                    </form>
    ...
    <script type="text/javascript">
        function validate()
        {
            ...
            if (sid.value.match(validRegex)) 
            {
                return true;
            }
            else 
            {
                alert("User id must be number starting with 0!");
                return false;
            }
        }
    }
...
<?php
    if(isset($_POST['issue_nap']))
    {
        $query = "insert into nap_issue values('$_POST[s_id]', '$_SESSION[user_id]', '$_POST[n_dm]')";
        $query_run = mysqli_query($connection,$query);
        ?>
        <script type="text/javascript">
