    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="col-lg-3" id="side_bar">
                ...
                <p class="p-2">
                    <b><h7> Welcome to Show Issued Napkins : </h7></b>
            ...
            <div class="col-lg-9">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="d-flex p-2 bg-light text-white">
                        <div class="p-2 bg-info">Total no of students received napkins :</div>
                        <?php 
                        ...
                        <table class="table table-hover table-bordered ">
                            ...
                            <?php
                                if(isset($_POST['show_std']))
                                {
                                    if($all == $_POST['class'])
                                    {
                                        $query = "select nap_issue.s_id, nap_issue.n_dm, student.s_name, student.gender, student.class from nap_issue left join student on nap_issue.s_id = student.s_id order by s_id";
                                        ...
                                        while($row = mysqli_fetch_assoc($query_run))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-success" href="update_issue_nap.php?id=<?php echo $row['s_id'];?>"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a> &nbsp &nbsp
                                                    <a type="button" class="btn btn-danger" href="delete_issue_nap.php?id=<?php echo $row['s_id'];?>"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
                                                </td>
                                            </tr>
                                    ...
                                    {
                                        $query = "select nap_issue.s_id, nap_issue.n_dm, student.s_name, student.gender, student.class from nap_issue left join student on nap_issue.s_id = student.s_id where student.class = $_POST[class] order by s_id";
                                        $query_run = mysqli_query($connection,$query);
                                        while($row = mysqli_fetch_assoc($query_run))
                                        {
                                            $s_name = $row['s_name'];
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-success" href="update_issue_nap.php?id=<?php echo $row['s_id'];?>">Update</a>
                                                    <a type="button" class="btn btn-danger" href="delete_issue_nap.php?id=<?php echo $row['s_id'];?>">Delete</a>
                                                </td>
                                            </tr>
