    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="col-lg-3" id="side_bar">
                ...
                <p class="p-2">
                    <b><h7> Welcome to Add Students : </h7></b>
                ...
                <div class="col-lg-8">
                    <form action="" method="post" class="p-3" onsubmit="return validateid() && validatename()">
                        <div class="form-group">
                            ...
                            <input type="text" name="s_id" id="s_id" class="form-control"  placeholder="Student ID" required> <br>
                        </div>
                        <div class="form-group">
                            <label>Student Name :</label>
                            <input type="text" name="s_name" id="s_name" class="form-control"  placeholder="Student Name" required> <br>
                        </div>
                        <div class="form-group">
...
<?php
    if(isset($_POST['add_std'])){
        ...
        $query = "insert into student values('$_POST[s_id]','$_POST[s_name]','$_POST[class]','$_POST[gender]')";
