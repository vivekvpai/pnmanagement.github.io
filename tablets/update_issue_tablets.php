<?php
    ...
    $connection = mysqli_connect ("remotemysql.com","bjBEokAclb","");
    $db = mysqli_select_db ($connection,"bjBEokAclb");
    $s_id = "";
    $class = "";
    $t_name = "";
    $query = "select * from t_issue where s_id = '$_GET[id]'";
    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="col-lg-3" id="side_bar">
                ...
                <p class="p-2">
                    <b><h7> Welcome to Update issued tablets : </h7></b>
                ...
                <div class="col-lg-10">
                    ...
                    <?php
                        ...
                        {   
                            $test_name = "";
                            $test_class = "";
                            $query = "select s_name, class from student where s_id = $_POST[s_id]";
                            $query_run = mysqli_query($connection,$query);
                            while($row = mysqli_fetch_assoc($query_run)){
                            ...
                            if($test_name != "")
                            {
                                ...
                                <div class="form-row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <label class="sr-only" for="inlineFormInputGroup">class</label>
                                        <div class="input-group mb-2">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text"> Class </div>
                                            </div>
                                            <input type="text" name="class" class="form-control" required value="<?php echo $class;?>" id="class" disabled>
                                        </div>
                                    </div>
                                </div>
                            ...
                            ?>
                                <div class="alert alert-danger" role="alert">
                                    No record found of the student!
                                </div>
                            <?php
                            }
                        }
                    ?>
                        ...
                        <div class="input-group pl-3 pr-3 row">
                            <input class="form-control" type="text" id="s_id" name="s_id" placeholder="Student ID" required value="<?php echo $s_id ?>">
                            <button class="btn btn-outline-success" type="submit" name="search_std">Search Student</button>
                        </div>
                        <br>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="t_name" required>
                                <option>-Select Tablet name-</option>
                                <?php
                                    $query = "select t_name from tablets";
                                    $query_run = mysqli_query($connection,$query);
                                    while($row = mysqli_fetch_assoc($query_run)){
                                        ?>
                                        <option><?php echo $row['t_name'];?></option>
                                        <?php
                                    }
                                ?>
                            </select> <br>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="t_dm" class="form-control" value="<?php echo date("yy-m-d");?>" required>
                        </div>	<br>
                        <button class="btn btn-primary" name="update_t_issue">Update</button>
                    </form>    
                </div>
...
<?php
    session_start();
    if(isset($_POST['update_t_issue'])){
        $connection = mysqli_connect("remotemysql.com","bjBEokAclb","");
        $db = mysqli_select_db($connection,"bjBEokAclb");
        $query = "update t_issue set t_name = '$_POST[t_name]', s_id = '$_POST[s_id]', user_id = '$_SESSION[user_id]', t_dm = '$_POST[t_dm]' where s_id = '$_GET[id]'";
        $query_run = mysqli_query($connection,$query);
