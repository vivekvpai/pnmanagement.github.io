    ...
    <div class="col-lg-12">
        <div class="row" >
            ...
            <div class="col-lg-3" id="side_bar">
                ...
                <p class="p-2">
                    <b><h7> Welcome to Add Tablets : </h7></b>
                ...
                <div class="col-lg-10">
                    <form action="" method="post" class="p-3" onsubmit="return validatename() && validatecontent()">
                        <div class="form-group">
                            ...
                            <input type="text" name="t_name" id="t_name" class="form-control" placeholder="tablet name" required> <br>
                        </div>
                        <div class="form-group">
                            <label>Tablet Content :</label>
                            <input type="text" name="content" id="content" class="form-control" placeholder="tablet Content" required> <br>
                        </div>
                        <div class="form-group" >
                        ...
                        <button class="btn btn-primary" name="add_tablet">Add Tablets</button>
                    </form>
...
<?php
    if(isset($_POST['add_tablet'])){
        ...
        $query = "insert into tablets values('$_POST[t_name]','$_POST[content]','$_POST[cat_class]')";
        $query_run = mysqli_query($connection,$query);
    ?>
    <script type="text/javascript">
        alert("Tablets added successfully...");
        window.location.href = "add_tablets.php";
    </script>
    <?php
    }
?>