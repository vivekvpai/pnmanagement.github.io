    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-3" id="side_bar">
                ...
                <p class="p-2">
                    <b><h7> Welcome to Issue Tablets : </h7></b>
            ...
            <div class="col-lg-9">
                ...
                <div class="col-lg-10">
                    <form action="" method="post" class="p-3" onsubmit="return validateid()">
                        ...
                        <div class="col-6">
                            <button class="btn btn-success btn-block" name="issue_tablet">Issue </button>
                        </div>
...
<?php
    if(isset($_POST['issue_tablet']))
    {   
        $connection = mysqli_connect("remotemysql.com","bjBEokAclb","q8e75oGyd0");
        $db = mysqli_select_db($connection,"bjBEokAclb");
        $query = "insert into t_issue values(null, '$_POST[t_name]', '$_POST[s_id]', '$_SESSION[user_id]', '$_POST[t_dm]')";
        $query_run = mysqli_query($connection,$query);
        ?>
        <script type="text/javascript">
